                            ...
                            <Grid container className={classes.intro}>
                                <Grid item>
                                    ...
                                    <Typography variant="h4" className={classes.meInfo}>
                                        I am a passionate web developer with a curious mindset. The internet has always piqued my interest which led me to pursue a career in web development. On my free time, I do my personal projects which involves coding and electronics. Here's some of my projects from freelancing and school.
                                    </Typography>
                                </Grid>
                            </Grid>
                        </div>
